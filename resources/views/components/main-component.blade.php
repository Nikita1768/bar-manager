    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        body {
            ...
            background: radial-gradient(circle at top left, rgba(168, 95, 50, .10), transparent 28%),
        ...
        @media (max-width: 920px) {
            ...
            .content-grid, .two-col, .three-col, .kpi-grid, .form-grid {
                grid-template-columns: 1fr;
            }
